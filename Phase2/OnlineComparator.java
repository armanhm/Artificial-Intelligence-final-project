...
public class OnlineComparator implements Comparator {
    ...
    public OnlineComparator(int[][] weightSet , int[] timingSet){
    ...
    public static int frontier(int[][] board , int player){
        int exoplayer = (player==1) ? 2 : 1;

        int myF = BoardHelper.getFrontierSquares(board,player).size();
        int opF = BoardHelper.getFrontierSquares(board,exoplayer).size();
