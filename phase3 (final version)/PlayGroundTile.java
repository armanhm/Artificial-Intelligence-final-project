...
public class PlayGroundTile extends JLabel implements MouseListener{
    ...
    public PlayGroundTile(GameHandler ge , JPanel parent, int i, int j){
        this.ge = ge;
        this.parent = parent;
        this.i = i;
        this.j = j;
    ...
    public void paint(Graphics g) {
        ...
        if(!text.isEmpty()){
            ...
            Font font = g.getFont();
            Font fount = new Font(font.getName(),Font.PLAIN,30);
            g.setFont(fount);
